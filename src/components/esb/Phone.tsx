...
export function Phone({ children, tone = "dark" }: { children: ReactNode; tone?: "dark" | "light" | "pink" }) {
  ...
  return (
    <div className="relative w-[min(360px,100%)] h-[760px] max-w-full rounded-[44px] p-[10px] bg-gradient-to-b from-[oklch(0.3_0.03_280)] to-[oklch(0.1_0.02_280)] shadow-[0_60px_120px_-30px_oklch(0_0_0/0.7)] border border-white/10">
