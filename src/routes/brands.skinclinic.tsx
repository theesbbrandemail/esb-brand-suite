...
import { Stethoscope, Activity, BarChart3, Package, Sparkles, Users, Bot } from "lucide-react";

export const Route = createFileRoute("/brands/skinclinic")({
  head: () => ({
    meta: [
      { title: "Skin Clinic — ESB Brand" },
      { name: "description", content: "Aesthetics procedures & treatment plans" },
      { property: "og:title", content: "Skin Clinic — ESB Brand" },
      { property: "og:description", content: "Aesthetics procedures & treatment plans" },
    ],
  }),
  component: Page,
});
  ...
  return (
    <Shell>
      <StubPage
        kind="Brand"
        name="Skin Clinic"
        tagline="Aesthetics procedures & treatment plans"
        description="Clinical workspace for aesthetics: bookings, procedure protocols (PDO, Botox, fillers, Endo Laser), progress photos, consent forms and Aesthetic Nurses AI assistance."
        icon={Stethoscope}
        accent="rose"
        kpis={[
