...
import { ShoppingBag, Activity, BarChart3, Package, Sparkles, Users, Bot } from "lucide-react";

export const Route = createFileRoute("/brands/derma")({
  head: () => ({
    meta: [
      { title: "Derma Aesthetics — ESB Brand" },
      { name: "description", content: "Skincare retail & preorder pipeline" },
      { property: "og:title", content: "Derma Aesthetics — ESB Brand" },
      { property: "og:description", content: "Skincare retail & preorder pipeline" },
    ],
  }),
  component: Page,
});
  ...
  return (
    <Shell>
      <StubPage
        ...
        tagline="Skincare retail & preorder pipeline"
        description="Strictly sales: catalog, stock movement, preorders, customer LTV, basket recommendations driven by Client AI Suite and Skincare Kitchen formulations."
        icon={ShoppingBag}
        accent="violet"
        kpis={[
